...
class DashboardController extends Controller
{
    ...
    public function category_insert(Request $request)
    {
        ...
        [
            ...
            $insert = new product_category();
            $insert->category_name = $request->category_name;
            $insert->parent_id = $request->division_name;
            $insert->save();
    ...
    public function category_update(Request $request, $id)
    {
        ...
        $data = product_category::findOrFail($id);
            ...
            $data->parent_id = $request->division_name;
    ...
    public function website_setting_store(Request $request){
        ...
        if($request->hasFile('file')){
            ...
            $filename = time().uniqid().$image->getClientOriginalName();
            $image->move('uploads', $filename);
            $setting->logo = 'uploads/'.$filename;
        }
        $setting->phone = $request->phone;
        $setting->email = $request->email;
        $setting->address = $request->address;
        $setting->welcome_text = $request->welcome_text;
