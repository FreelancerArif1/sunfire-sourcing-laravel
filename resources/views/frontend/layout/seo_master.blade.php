...
<head>
    ...
    <link rel="icon" href="/frontend/images/favicon.png" type="image/gif" sizes="100x100">
    ...
    <meta name="keywords" content="@yield('meta_keywords', 'garments, sourcing, bangladesh')">
    ...
    <meta property="og:image" content="@yield('og_image', asset($wss->logo))">
</head>
    ...
    <div class="modal" tabindex="-1" role="dialog" aria-labelledby="search_modal" id="search_modal"> <button
        ...
        <div class="widget widget_search">
            <form method="get" class="searchform search-form form-inline"
                ...
                <div class="form-group bottommargin_0"> <input type="text" value="" name="search"
                        class="form-control" placeholder="Search keyword" id="modal-search-input"> </div> <button
                    type="submit" class="theme_button color1 no_bg_button">Search</button>
            </form>
        </div>
    </div>
