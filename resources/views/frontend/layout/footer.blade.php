<footer class="page_footer ls pt-4" style="background-color: #e73525;">
...
<section class="page_copyright" style="background-color: #d52616;">
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-6 text-left grid_6" style="color: #f1f1f1; font-size: 10px;"> &copy; <?php echo date('Y'); ?>  All Rights Reserved | Developed By <a href="https://www.vmsl.com.bd" target="__blank" style="color: #f1f1f1;"> <b>VMSL</b> </a>  </div>
			<div class="col-xs-6 text-right grid_6">
				<div class="page_social" style="color: #f1f1f1;"> 
					...
					<a class="social-icon dark-icon" style="color: #f1f1f1;" target="_blank" href="{{ $wss->twiter ?? '#' }}" title="Twitter"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
