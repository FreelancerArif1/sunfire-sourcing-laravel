            ...
            <div class="row">
                <div class="col-xs-12 col-md-12 col-lg-12 col-md-push-1 col-lg-push-1">
                    ...
                    <div class="related-products">
                        ...
                        <div class="owl-carousel with_shadow_items" data-dots="false" data-nav="true" data-loop="true" data-autoplay="true" data-responsive-lg="4" data-responsive-md="3" data-responsive-sm="3" data-responsive-xs="2">
                                    ...
                                    <div class="item-media-wrap bottommargin_25">
                                        <div class="item-media"> 
                                            <a href="{{ route('product.view', $row->id) }}">
                                                <img src="{{ asset($row->image_front) }}" style="height: 267px; width: 267px;" alt="" />
                                                <img src="{{ asset($row->image_back) }}" style="height: 267px; width: 267px;" alt="" />
                                            </a>
                                        </div>
                                    </div>
