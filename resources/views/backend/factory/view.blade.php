        ...
        <div class="col-md-10">
            <div  class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><a href="/dashboard/factory" class="btn btn-primary btn-sm"><i class="fas fa-arrow-left"></i></a> Factory Details</h6>
                </div>
                    <div class="card-body">
                        <div class="row">
                        ...
                        <hr>
                        <div class="row">
                            <div class="col-md-2"><strong>Certification:</strong></div>
                            <div class="col-md-10">
