        ...
        <div class="col-md-10">
            <div  class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><a href="/dashboard/our-partners" class="btn btn-primary btn-sm"><i class="fas fa-arrow-left"></i></a> Remove Partner ?</h6>
                </div>
                    <div class="card-body">
                        <form method="POST">
                            @csrf
                            ...
                            <div class="row justify-content-center">
                                ...
                                <a href="/dashboard/our-partners" class="btn btn-primary btn-sm">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
