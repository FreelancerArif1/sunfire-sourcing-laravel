        ...
        <div class="col-md-10">
            <div  class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><a href="/dashboard/ourclients" class="btn btn-primary btn-sm"><i class="fas fa-arrow-left"></i></a> Edit Partner</h6>
                </div>
                    <div class="card-body">
                        <form method="POST"  enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <small class="form-text text-muted">Image Dimension Should Be 500*500 or squared for box view</small>
                                    <div class="preview">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <a href="/dashboard/ourclients" class="btn btn-primary btn-sm">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
