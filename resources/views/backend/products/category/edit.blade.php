                    ...
                    <div class="card-body">
                        <form method="POST" >
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control form-control-sm" name="division_name">
                                        <option value="">-- Select Division --</option>
                                        @foreach(App\product_division::all() as $division)
                                            <option value="{{$division->id}}" @if($data->parent_id == $division->id) selected="" @endif>{{ $division->division_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
