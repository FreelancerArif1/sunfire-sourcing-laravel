...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2022 at 06:34 AM
...
(1, 'Aeon Apparel', 'admin@apparel360.com', '$2y$10$pW05729wRaf3gJVGII5sBOkXbTx.8nFUXqQOzdWFJbHfN1hX90HX.', 1, NULL, '2022-07-13 06:15:38');
...
INSERT INTO `website_setting` (`id`, `name`, `logo`, `phone`, `email`, `address`, `facebook`, `linkedin`, `twiter`, `instagram`, `created_at`, `updated_at`) VALUES
(1, 'Apparel360', 'uploads/1669896692638899f4c3842Apparel360-Logo.png', '+8801724118115', 'Info@apparel360.com.bd', '5th Floor (Lift-04), 27, Hazi Komor Uddin Tower, Ashkona, Airport, Uttara, Dhaka -1230, Bangladesh', 'www.facebook.com/', 'https://bd.linkedin.com/', 'https://twitter.com/', '#', '2022-12-03 07:48:55', '2022-12-03 01:51:41');
